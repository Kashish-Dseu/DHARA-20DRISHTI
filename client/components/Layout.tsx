        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="font-extrabold tracking-tight text-xl leading-none">
              Dhara<span className="text-primary">Drishti</span>
            </p>
            <p className="text-xs text-muted-foreground">
              Technology with roots in the soil.
            </p>
          </div>
        </div>
        <nav className="text-sm font-medium text-muted-foreground">
          <ul className="space-y-1">
            ...
            <li>
              <NavLink
                to="/login"
                className="rounded-md px-3 py-2 hover:bg-accent block"
              >
                Login
              </NavLink>
            </li>
